...
type StubSubgame struct {
	Subgame
	GlobalLocations map[string]Location
}

func (subgame StubSubgame) GetButtonTitle() string {
	return "Stub Title"
}

func (subgame StubSubgame) GetLayoutName() string {
	return "main_layout"
}

func (subgame StubSubgame) Enter(state *State) {
