...
type TalkToWomanOneAction struct{}

func (action TalkToWomanOneAction) GetButtonTitle() string {
	return "Talk to woman"
}

func (action TalkToWomanOneAction) GetLayoutName() string {
	return "main_layout"
}

func (action TalkToWomanOneAction) Run() {
	topTitle := "Todo"
	topDescription := `Todo`
