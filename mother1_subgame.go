...
type Mother1Subgame struct {
	Subgame
	GlobalLocations map[string]Location
}

func (subgame Mother1Subgame) GetButtonTitle() string {
	return "Mother1 Title"
}

func (subgame Mother1Subgame) GetLayoutName() string {
	return "main_layout"
}

func (subgame Mother1Subgame) Enter(state *State) {
