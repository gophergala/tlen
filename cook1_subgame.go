...
type Cook1Subgame struct {
	Subgame
	GlobalLocations map[string]Location
}

func (subgame Cook1Subgame) GetButtonTitle() string {
	return "Cook1 Title"
}

func (subgame Cook1Subgame) GetLayoutName() string {
	return "main_layout"
}

func (subgame Cook1Subgame) Enter(state *State) {
