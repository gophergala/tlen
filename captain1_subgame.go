...
type Captain1Subgame struct {
	Subgame
	GlobalLocations map[string]Location
}

func (subgame Captain1Subgame) GetButtonTitle() string {
	return "Captain1 Title"
}

func (subgame Captain1Subgame) GetLayoutName() string {
	return "main_layout"
}

func (subgame Captain1Subgame) Enter(state *State) {
